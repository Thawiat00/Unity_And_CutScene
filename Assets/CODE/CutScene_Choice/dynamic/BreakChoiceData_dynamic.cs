...
public class BreakChoiceScene_dynamic
{
    ...
    public List<SceneData_dynamic> sceneData; // List ??????????? scene
}
...
{
    public List<string> option_call_option_1; // ???????? 1
    public List<string> option_call_option_2; // ???????? 2
    public List<string> option_call_option_3; // ???????? 3
}

[System.Serializable]
public class OptionCallAllAnswer_dynamic
{
    public List<string> option_answer_option_1; // ????? 1
    public List<string> option_answer_option_2; // ????? 2
    public List<string> option_answer_option_3; // ????? 3
}

[System.Serializable]
public class DialogData_dynamic
{
    public List<string> cutscene_choice; // ???????????? cutscene choices
